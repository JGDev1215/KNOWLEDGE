...
| Reader route | Pass | `/work/divine-comedy` loads the reader with section navigation and source content. |
...
| U-004 | Low | Fixed | `npm run audit:usage` verifies the `Open Source` blob popup in Chromium. |
