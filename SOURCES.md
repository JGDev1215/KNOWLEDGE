...
This file records source/provenance references for the knowledge pages currently tracked in the public repository.
...
Lecture-derived pages, raw lecture transcripts, missing-provenance pages, and modern-author lecture material were removed from tracked public source. `RIGHTS_CLEARANCE.md` records the removal decision.
