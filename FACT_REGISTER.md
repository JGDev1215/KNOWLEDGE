...
| F-025 | `Knowledge/dantes_hierarchy_of_hell.html` and `Knowledge/dantes_la_commedia.html` | Added Dante primary-source excerpts should have public-domain source provenance. | Verified | Project Gutenberg Inferno eBook 1001, Purgatorio eBook 1002, and Paradiso eBook 1003 are recorded in `SOURCES.md` and page source cards. | Keep excerpts source-labeled. |
...
Primary public-domain text provenance is mostly supportable, and the app now visibly labels source status. Several lecture-derived pages still contain strong interpretive or hyperbolic claims. Those should be reframed as lecture theses, supported with citations, or removed from fact-style study cards.
